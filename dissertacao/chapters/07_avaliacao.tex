...
Engenharia de Software \cite{amigoni2010}, esta seção examina os limites da
avaliação nas quatro dimensões clássicas.
...
medir; comparações contra a gravação baseline, que usa um mecanismo de
...
Predictive Path Integral}) é estocástico por projeto: a cada ciclo de controle
